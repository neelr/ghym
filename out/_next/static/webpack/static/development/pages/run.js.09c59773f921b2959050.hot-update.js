  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Run, [{
    ...
    value: function render() {
      ...
      return __jsx(rebass__WEBPACK_IMPORTED_MODULE_9__["Flex"], {
        ...
        return __jsx("section", {
          ...
          __self: this
        }, "Drag 'n' drop your python files here, or click to select files")));
    ...
    value: function componentDidMount() {
      ...
      socket.on("done", function (d) {
        document.getElementById("console").value = "".concat(d.name, " has finished with the output:\n ").concat(String(d.out).replace(/,/g, "\n"));
      });
    }
  }]);
...
//# sourceMappingURL=run.js.09c59773f921b2959050.hot-update.js.map